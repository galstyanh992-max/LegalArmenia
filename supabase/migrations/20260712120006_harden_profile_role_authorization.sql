-- Forward migration: local-only profile/role authorization hardening.
-- Production application requires disposable authorization-matrix PASS and explicit release approval.
