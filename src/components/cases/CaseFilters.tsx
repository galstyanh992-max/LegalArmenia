...
import { IconSearch } from '@/components/icons/PremiumIcon';
...
export function CaseFilters({ filters, onFiltersChange }: CaseFiltersProps) {
  ...
  return (
    <div className="flex w-full flex-col gap-4 sm:flex-row sm:items-center">
      {/* Search */}
      <div className="field-premium relative flex-1">
        <IconSearch className="absolute left-3 top-1/2 h-4 w-4 -translate-y-1/2 text-[hsl(215_18%_55%)]" />
        <Input
